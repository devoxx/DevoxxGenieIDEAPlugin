...
public class GLMChatModelFactoryTest extends AbstractLightPlatformTestCase {
    ...
    public void setUp() throws Exception {
        ...
        when(settingsStateMock.getGlmKey()).thenReturn("dummy-api-key");
    ...
    void createChatModel() {
        var factory = new GLMChatModelFactory();
    ...
    public void testModelNames() {
        GLMChatModelFactory factory = new GLMChatModelFactory();
