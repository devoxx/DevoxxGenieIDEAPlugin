...
public class WebViewMessageRenderer {
    ...
    private void doAddChatMessage(@NotNull String messageHtml) {
        ...
        // JavaScript helper: remove welcome content (non-message children) before first chat message.
        // Welcome content is trusted internal HTML from WelcomeTemplate (not user input),
        // and this removal simply clears the container before appending the first message-pair.
        String clearWelcome =
        ...
        // messageHtml is generated by trusted internal ChatMessageTemplate, not user input.
        String js;
        if (messageId != null) {
