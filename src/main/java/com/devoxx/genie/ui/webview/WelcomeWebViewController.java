...
public class WelcomeWebViewController implements CustomPromptChangeListener {
    ...
    private @NotNull String generateWelcomeHtml() {
        ...
        htmlBuilder.append("<!DOCTYPE html>\n")
                ...
                .append("            margin: 0; \n")
                .append("            padding: 0; \n")
                .append("            background-color: " + (com.devoxx.genie.ui.util.ThemeDetector.isDarkTheme() ? "#2b2b2b" : "#f5f5f5") + "; \n")
                .append("            color: " + (com.devoxx.genie.ui.util.ThemeDetector.isDarkTheme() ? "#e0e0e0" : "#2b2b2b") + "; \n")
                .append("            overflow-y: auto; \n")
                .append("        }\n")
                .append("        h2 { margin-top: 20px; margin-bottom: 10px; color: " + (com.devoxx.genie.ui.util.ThemeDetector.isDarkTheme() ? "#64b5f6" : "#2196F3") + "; font-size: \" + Math.max((int)(editorFontSize * 1.2), 14) + \"px; }\n")
                .append("        a { color: " + (com.devoxx.genie.ui.util.ThemeDetector.isDarkTheme() ? "#64b5f6" : "#2196F3") + "; text-decoration: none; }\n")
