...
public class ConversationHistoryManager {
    ...
    private void processConversationMessages(Conversation conversation,
        ...
        try {
            ...
            while (messageIndex < messages.size()) {
                messageIndex = processMessageAtIndex(conversation, messages, messageIndex);
            }
            ...
            log.debug("Completed conversation restoration for ID: {} with {} messages",
    ...
    /**
     * Process a single message (or user+AI pair) at the given index and return the next index.
     */
    private int processMessageAtIndex(Conversation conversation,
                                      @NotNull List<ChatMessage> messages,
                                      int messageIndex) {
        ...
        context.setId(conversation.getId() + "_msg_" + messageIndex);
