...
public class KimiChatModelFactory implements ChatModelFactory {

    private final ModelProvider MODEL_PROVIDER = ModelProvider.Kimi;
    ...
    public List<LanguageModel> getModels() {
        return getModels(ModelProvider.Kimi);
    }
}
