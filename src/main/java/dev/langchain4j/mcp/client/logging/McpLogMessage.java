...
public record McpLogMessage(dev.langchain4j.mcp.client.logging.McpLogLevel level, String logger, JsonNode data) {
    ...
    public static McpLogMessage fromJson(JsonNode json) {
        dev.langchain4j.mcp.client.logging.McpLogLevel level = McpLogLevel.from(json.get("level").asText());
