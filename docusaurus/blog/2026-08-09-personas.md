...
![The DevoxxGenie tool window with the persona dropdown open, showing Developer, Reviewer, Architect and Test Engineer below the provider and model selectors](/img/Personas-Selection.png)
...
![The DevoxxGenie tool window at the start of a new conversation, with the Developer persona selected under the provider and model selectors](/img/Personas-Start.png)
