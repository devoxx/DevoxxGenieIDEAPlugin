...
The best part: Exo models work seamlessly with DevoxxGenie's [Agent Mode](/docs/features/agent-mode). The LLM gets full access to built-in tools - file reading, writing, editing, searching, and command execution - all running through your local cluster.
