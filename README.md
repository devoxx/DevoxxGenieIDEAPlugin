...
This feature will be introduced in v0.4.14. You’ll be able to drag and drop images directly into the input field when working with multimodal LLMs like Google Gemini, Anthropic Claude, ChatGPT 4.x, 
