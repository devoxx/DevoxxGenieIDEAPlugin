---
id: task-181
title: "[OPENGREP] User controlled data in methods like `innerHTML`, `outerHTML` or `document.write` is an anti-pattern that can lead to XSS vulnerabilities in file-references.js:40"
status: To Do
priority: medium
assignee: []
...
**Location:** /Users/stephan/IdeaProjects/DevoxxGenieIDEAPlugin/src/main/resources/webview/js/file-references.js:40
